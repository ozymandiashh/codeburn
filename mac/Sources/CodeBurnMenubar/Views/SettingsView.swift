...
private struct GeneralSettingsTab: View {
    ...
    var body: some View {
        Form {
            ...
            Section(L("Reset Forecast Data")) {
                Toggle(L("Refresh reset history from GitHub (hourly, no data sent)"), isOn: $refreshResetHistory)
